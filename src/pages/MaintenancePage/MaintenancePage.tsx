    ...
    <div className={styles.container}>
      <div className={styles.card}>
        <div className={styles.logoContainer}>
          <img src={logo} alt={COMPANY_INFO.name} className={styles.logo} />
        </div>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.subtitle}>
            We're working hard to improve your experience. Our website is
            currently undergoing scheduled maintenance.
          </p>
          <p className={styles.message}>
            We apologize for any inconvenience. Please contact us directly for
        ...
        <div className={styles.contactSection}>
          ...
          <div className={styles.contactGrid}>
            <a href={`tel:${COMPANY_INFO.phone.replace(/\s/g, '')}`} className={styles.contactItem}>
            ...
            >
              ...
              <div className={styles.contactDetails}>
                ...
                <span className={styles.contactValue}>{COMPANY_INFO.website}</span>
              </div>
            </a>
          </div>
          ...
          <div className={styles.addressSection}>
            ...
            <div className={styles.addressText}>
              ...
              <span className={styles.contactValue}>{COMPANY_INFO.fullAddress}</span>
            </div>
          </div>
